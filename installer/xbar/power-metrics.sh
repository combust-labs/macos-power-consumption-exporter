...
main() {
    ...
    echo "---"
    echo "Combined: ${combined_fmt} | color=white"
    echo "CPU: ${cpu_fmt} | color=white"
    echo "GPU: ${gpu_fmt} | color=white"
    ...
    echo "---"
    echo "Stop Exporter | bash='pkill' param='-f macos-power-consumption-exporter' terminal=false"
    echo "Restart Exporter | bash='sudo' param='/Applications/MacOS\\ Power\\ Consumption\\ Exporter.app/Contents/MacOS/launcher restart' terminal=true"
}
